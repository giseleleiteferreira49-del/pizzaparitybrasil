...
import upgradesBanner from "@/assets/barista-cafe.png.asset.json";
      ...
      <div className="relative z-30 w-full max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-12 items-center text-center lg:text-left">
        ...
        <div className="flex justify-center lg:justify-end items-end">
          <img
            ...
            className="w-auto h-[360px] lg:h-[640px] xl:h-[720px] object-contain object-bottom pointer-events-none select-none drop-shadow-[0_30px_60px_rgba(0,0,0,0.7)]"
          />
        </div>
      </div>
